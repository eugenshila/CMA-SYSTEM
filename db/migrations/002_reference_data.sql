...
INSERT INTO contribution_types (key, name, category, description, is_recurring, is_mandatory, default_amount, penalty_amount, due_day, account_code) VALUES
 ...
 ('last_respect_insurance','Last Respect Insurance','funeral','Last respect (funeral / final-expense) insurance — a monthly premium that pools financial support for funeral and end-of-life expenses, so loved ones are not burdened during difficult times.', TRUE, FALSE, 200, 0, 10, 'CMA-2500'),
...
INSERT INTO system_settings (key, value, group_name, description, is_secret) VALUES
 ('organisation', '{"name":"Catholic Men Association (CMA)","short_name":"CMA","parish":"St. Joseph Mukasa Parish, Kahawa West","diocese":"Archdiocese of Nairobi","motto":"Men of Faith, Men of Service","email":"cma@stjosephmukasa.or.ke","phone":"+254700000000","address":"P.O. Box 1234-00509, Kahawa West, Nairobi","currency":"KES","currency_symbol":"KSh","logo_url":null,"stamp_url":null}'::jsonb,'general','Organisation identity printed on receipts, statements and reports.', FALSE),

 ('last_respect_insurance', '{"title":"Last Respect Insurance","tagline":"Last respect insurance provides financial support for funeral and end-of-life expenses, ensuring your loved ones are not burdened during difficult times.","overview":"Last respect insurance, also known as funeral or last expense insurance, is designed to cover the costs associated with a person’s funeral and related end-of-life expenses. These policies provide immediate cash payouts to beneficiaries, helping families manage funeral arrangements without financial stress.","premium":"KSh 200 per member per month","benefit":"KSh 150,000 cash payout to the beneficiary family, paid within 48 hours of claim submission","key_features":[{"label":"Coverage amounts","value":"Policies typically cover amounts ranging from KSh 50,000 to KSh 500,000, depending on the provider and plan."},{"label":"Eligibility","value":"Most plans cover the principal member aged 18–65, with options to include spouses, children and parents or parents-in-law. Children are usually covered from 1 month to 24 years, with some plans extending cover for school-going children up to 25 years."},{"label":"Dependents","value":"Many plans allow coverage for multiple family members — spouses, children and parents — ensuring comprehensive family protection."},{"label":"Payout timeline","value":"Claims are processed quickly, with payouts made within 48 hours of claim submission."},{"label":"Cause of death","value":"Coverage generally includes death due to illness and accidents; some plans apply a waiting period to illness-related claims."}],"benefits":["Financial relief — reduces the financial burden on family members during bereavement.","Peace of mind — ensures funeral arrangements and final wishes are honoured with dignity.","Customisable plans — individual or family packages with options to include parents and multiple children, and flexible sum-assured levels.","Additional support — certain plans provide extra payouts for added assistance or in the event of accidental death."],"conclusion":"Last respect insurance is a practical solution for ensuring financial security and honouring final wishes. Under the CMA scheme, members contribute KSh 200 per month and the enrolled family receives a KSh 150,000 cash benefit within 48 hours. When choosing any plan, consider coverage amounts, eligible dependents, payout timelines and additional benefits."}'::jsonb,'welfare','Self-service description of the parish Last Respect Insurance scheme, shown on the funerals page.', FALSE),
 ...
 ('payments', '{"mpesa":{"enabled":false,"mode":"sandbox","short_code":null,"passkey":null,"consumer_key":null,"consumer_secret":null,"callback_url":null,"stk_timeout_seconds":60},"airtel":{"enabled":false,"client_id":null,"client_secret":null},"bank":{"enabled":true,"account_name":"CMA St. Joseph Mukasa","account_number":"01000000000","bank":"Catholic Bank","swift":null},"cash":{"enabled":true},"manual_entry":{"enabled":true,"requires_verification":true}}'::jsonb,'payments','Payment channels and mobile money (Daraja) configuration.', TRUE),
